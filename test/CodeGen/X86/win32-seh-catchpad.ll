...
entry:
  ...
  %cs1 = catchswitch none, unwind to caller [label %__except.ret]

__except.ret:                                     ; preds = %catch.dispatch
  %0 = catchpad %cs1 [i8* bitcast (i32 ()* @try_except_filter_catchall to i8*)]
...
entry:
  ...
  %cs1 = catchswitch none, unwind label %catch.dispatch.11 [label %__except.ret]

__except.ret:                                     ; preds = %catch.dispatch
  %0 = catchpad %cs1 [i8* bitcast (i32 ()* @nested_exceptions_filter_catchall to i8*)]
...
__try.cont:                                       ; preds = %entry, %__except.ret
  ...
  %cs2 = catchswitch none, unwind label %catch.dispatch.11 [label %__except.ret.7]

__except.ret.7:                                   ; preds = %catch.dispatch.5
  %1 = catchpad %cs2 [i8* bitcast (i32 ()* @nested_exceptions_filter_catchall to i8*)]
...
__try.cont.9:                                     ; preds = %__try.cont, %__except.ret.7
  ...
  %cs3 = catchswitch none, unwind label %catch.dispatch.17 [label %__except.ret.13]

__except.ret.13:                                  ; preds = %catch.dispatch.11
  %2 = catchpad %cs3 [i8* bitcast (i32 ()* @nested_exceptions_filter_catchall to i8*)]
...
__try.cont.15:                                    ; preds = %__try.cont.9, %__except.ret.13
  ...
  %cs4 = catchswitch none, unwind to caller [label %__except.ret.19]

__except.ret.19:                                  ; preds = %catch.dispatch.17
  %3 = catchpad %cs4 [i8* bitcast (i32 ()* @nested_exceptions_filter_catchall to i8*)]
...
__except.20:                                      ; preds = %__except.ret.19
  ...
  %cs5 = catchswitch none, unwind to caller [label %__except.ret.25]

__except.ret.25:                                  ; preds = %catch.dispatch.23
  %4 = catchpad %cs5 [i8* bitcast (i32 ()* @nested_exceptions_filter_catchall to i8*)]
...
__try.cont.27:                                    ; preds = %__except.20, %__except.ret.25
  ...
  %cs6 = catchswitch none, unwind to caller [label %__except.ret.32]

__except.ret.32:                                  ; preds = %catch.dispatch.30
  %5 = catchpad %cs6 [i8* bitcast (i32 ()* @nested_exceptions_filter_catchall to i8*)]
